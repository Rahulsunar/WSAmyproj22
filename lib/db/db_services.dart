...
class DatabaseHelper {
  ...
  //Now lets create an instance of the databse
  static DatabaseHelper? _databaseHelper; // this _databaseHelper will
  //be refereced using 'this' keyword.It helps to access getters and setters of the class.
  //for an example: _database getter is used when we want to initialize the db.
  factory DatabaseHelper() {
    ...
    if (_databaseHelper == null) {
      ...
      //because of that null check this line above runs only once
    }
  ...
  Future<List<TContact>> getContactList() async {
    var contactMapList =
        await getContactMapList(); // Fetch the 'Map List' from the database (replace with the actual method)
